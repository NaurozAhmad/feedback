...
describe('Keyword API:', function() {
  ...
  describe('PUT /api/keywords/:id', function() {
    ...
    it('should respond with the original keyword', function() {
      updatedKeyword.name.should.equal('New Keyword');
      updatedKeyword.info.should.equal('This is the brand new keyword!!!');
    });
